            ...
            <div class="row">
                @foreach($stories as $story)
                    <div class="col-md-4 my-4">
                        ...
                        <p><span class="text-secondary">Ecrit par:</span> John <span class="text-secondary">le 24 Septembre 2019</span></p>
                        <p><a class="btn btn-secondary" href="#" role="button">Lire</a></p>
                    </div>
                @endforeach
            </div>
